  ...
  return (
    <>
      <button
        ...
        disabled={isDeleting}
        className={`inline-flex items-center justify-center p-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${className}`}
        aria-label={`Delete ${releaseTitle} from collection`}
        title={isDeleting ? "Deleting..." : "Delete release from collection"}
      >
        {/* Trash Icon */}
        <svg
